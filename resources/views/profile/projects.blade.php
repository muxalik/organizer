                        ...
                        <div class="ms-auto">
                            <div class="dropdown zindex-2">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a class="dropdown-item" href="javascript:void(0);">Rename project</a>
                                    </li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center flex-wrap">
                        ...
                        <div class="text-end mb-3">
                            <h6 class="mb-1">Start Date: <span class="text-body fw-normal">18/8/21</span>
                            </h6>
                            <h6 class="mb-1">Deadline: <span class="text-body fw-normal">21/6/22</span></h6>
                        </div>
                    </div>
                    <p class="mb-0">Time is our most valuable asset, that's why we want to help you save it
                        by creating…</p>
                </div>
                <div class="card-body border-top">
                    <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto">
                            <a href="javascript:void(0);" class="text-body"><i class="bx bx-chat"></i>
                                236</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-start">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="me-2">
                                <h5 class="mb-1"><a href="javascript:;" class="h5 stretched-link">App
                                        Design</a></h5>
                                <div class="client-info d-flex align-items-center">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center flex-wrap">
                        ...
                        <div class="text-end mb-3">
                            <h6 class="mb-1">Start Date: <span class="text-body fw-normal">24/7/21</span>
                            </h6>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center flex-wrap">
                        ...
                        <div class="text-end mb-3">
                            <h6 class="mb-1">Start Date: <span class="text-body fw-normal">10/2/19</span>
                            </h6>
                            <h6 class="mb-1">Deadline: <span class="text-body fw-normal">12/9/22</span></h6>
                        </div>
                    </div>
                    <p class="mb-0">Your domain name should reflect your products or services so that your...
                    </p>
                </div>
                <div class="card-body border-top">
                    <div class="d-flex align-items-center mb-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center flex-wrap">
                        ...
                        <div class="text-end mb-3">
                            <h6 class="mb-1">Start Date: <span class="text-body fw-normal">12/12/20</span>
                            </h6>
                            <h6 class="mb-1">Deadline: <span class="text-body fw-normal">25/12/21</span>
                            </h6>
                        </div>
                    </div>
                    <p class="mb-0">Use this template to organize your design project. Some of the key
                        features are…</p>
                </div>
                <div class="card-body border-top">
                    <div class="d-flex align-items-center mb-3">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-start">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="me-2">
                                <h5 class="mb-1"><a href="javascript:;" class="h5 stretched-link">Logo
                                        Design</a></h5>
                                <div class="client-info d-flex align-items-center">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center flex-wrap">
                        ...
                        <div class="text-end mb-3">
                            <h6 class="mb-1">Start Date: <span class="text-body fw-normal">17/8/21</span>
                            </h6>
                            <h6 class="mb-1">Deadline: <span class="text-body fw-normal">02/11/21</span>
                            </h6>
                        </div>
                    </div>
                    <p class="mb-0">Premium logo designs created by top logo designers. Create the branding
                        of business.</p>
                </div>
                <div class="card-body border-top">
                    <div class="d-flex align-items-center mb-3">
